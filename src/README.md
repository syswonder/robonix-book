...
- [命名空间与契约](architecture/namespace-and-contracts.md)——namespace 树、契约 ID（`contract_id`）、`rust/contracts` 与 robonix-codegen、多传输、通道协商
- [接口目录](interface-catalog/index.md)——**primitive**（Primitive，原语）与 **service**（Service，服务）分目录说明
