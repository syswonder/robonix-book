...
- [命名空间与契约](architecture/namespace-and-contracts.md)——namespace 树、契约 ID（`contract_id`）、`capabilities/` 与 robonix-codegen、多传输、通道协商
- [接口目录](interface-catalog/index.md)——primitive（原语）/ service（服务）/ system（系统）三类契约分目录说明
