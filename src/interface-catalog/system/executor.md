...
|---|---|---|---|
| `robonix/system/executor` | `rpc_server_stream` | [`executor/Execute`](../../reference/idl.md#executor-srv-execute-srv)（`pilot/Plan` → 流 `executor/CapabilityCallEvent`） | `system/executor.v1.toml` |
