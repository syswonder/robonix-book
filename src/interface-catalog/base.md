...
| abstract_interface_id | IDL | gRPC 映射 |
|-----------------------|-----|-----------|
...
| abstract_interface_id | 方向 | IDL | gRPC 类型 |
|-----------------------|------|-----|-----------|
| `robonix/prm/base/move` | input | `msg/MoveCommand.msg` | `message MoveCommand` |
| `robonix/prm/base/odom` | output | `nav_msgs/msg/Odometry.msg` | `nav_msgs.Odometry` |
