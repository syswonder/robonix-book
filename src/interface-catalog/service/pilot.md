...
|--------------------------|------|-------------|-----------|
| `robonix/srv/runtime/pilot` | `rpc_server_stream` | `pilot/HandleIntent_Request` → stream `pilot/PilotEvent` | `sys/pilot.v1.toml` |
...
- **注册**：`declare_interface_full(..., "robonix/srv/runtime/pilot")`，接口叶子名通常为 `pilot`
