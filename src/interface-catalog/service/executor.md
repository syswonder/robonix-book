...
|--------------------------|------|-------------|-----------|
| `robonix/srv/runtime/executor` | `rpc_server_stream` | `executor/Execute_Request` → stream `executor/TaskCallEvent` | `sys/executor.v1.toml` |
...
- 注册：`declare_interface_full(..., "robonix/srv/runtime/executor")`，接口叶子名通常为 `executor`
