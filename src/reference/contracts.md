...
| `robonix/primitive/camera/driver` | Lifecycle control interface for camera primitive providers. | primitive | `rpc` | [`lifecycle/srv/Driver.srv`](idl.md#lifecycle-srv-driver-srv) | `primitive/camera/driver.v1.toml` |
| `robonix/primitive/camera/extrinsics` | Static transform from the robot body frame to the camera optical frame. | primitive | `topic_out` | [`common_interfaces/geometry_msgs/msg/TransformStamped.msg`](idl.md#common-interfaces-geometry-msgs-msg-transformstamped-msg) | `primitive/camera/extrinsics.v1.toml` |
...
| `robonix/primitive/chassis/driver` | Lifecycle control interface for chassis primitive providers. | primitive | `rpc` | [`lifecycle/srv/Driver.srv`](idl.md#lifecycle-srv-driver-srv) | `primitive/chassis/driver.v1.toml` |
...
| `robonix/service/speech/driver` | Lifecycle control interface for speech service providers. | service | `rpc` | [`lifecycle/srv/Driver.srv`](idl.md#lifecycle-srv-driver-srv) | `service/speech/driver.v1.toml` |
