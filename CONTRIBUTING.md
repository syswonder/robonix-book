...
Robonix documentation is maintained in the open. Before changing a page, read the Chinese [documentation contribution guide](src/contributing/documentation.md) and [writing standard](STYLE.md).
...
Open the generated `book/` and inspect every changed page. For command, configuration, interface, or hardware instructions, also execute the documented procedure against the stated Robonix commit. Include the evidence in the pull request.
