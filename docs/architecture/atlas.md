...
下表仅列出最常用的 Atlas RPC **接口摘录**。请求/响应字段、枚举和完整服务定义以 [`system/atlas/proto/atlas.proto`](https://github.com/syswonder/robonix/blob/223675d9a5000e70debae4f2512404cec5c9c442/system/atlas/proto/atlas.proto) 为准。
