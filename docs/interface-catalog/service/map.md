...
| `robonix/service/map/odom` | `topic_out` | ROS 2 topic（未绑定外部 odom 时） | [`nav_msgs/Odometry`](../../reference/idl.md#common-interfaces-nav-msgs-msg-odometry-msg) | `service/map/odom.v1.toml` |
