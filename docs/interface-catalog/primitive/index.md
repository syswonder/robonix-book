...
| 域 | 覆盖 | 能力约定数 |
|----|------|--------|
| [机械臂](arm.md) | 关节指令与反馈、笛卡尔目标和末端位姿 | 5 |
| [灵巧手](hand.md) | 手指级和轴级位置控制、状态以及速度与力矩上限 | 10 |
| [底盘](chassis.md) | 差速或全向底盘的速度控制与里程反馈 | 4 |
| [四足底盘](quadruped.md) | 有边界运动、连续速度输入、姿态和里程计 | 5 |
...
| [机器人描述](robot-description.md) | 机器人描述能力提供方的生命周期入口 | 1 |

表中 10 个域共有 47 条标准能力约定，不表示某个部署已经注册全部接口。字段和线协议结构以[自动生成的能力约定与 IDL 参考](../../reference/index.md)为准。
