...
`soma.yaml` 的强制字段、完整移动操作机器人示例和验收流程见[机器人本体接入指南](../../integration-guide/vendor-onboarding.md#32-创建-somayaml)；本体描述文件的自动选择、`system.soma` 参数和日志诊断见[系统部署与启动流程](../../architecture/deployment-and-startup.md#soma-sidecar-与进程配置)。
